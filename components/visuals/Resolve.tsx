  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'color-mix(in oklab, var(--color-bone) calc(var(--p) * 100%), var(--color-ink))',
        }}
      >
        <div className="shell w-full">
          <p
            ...
            style={{
              ...
              color:
                'color-mix(in oklab, var(--color-graphite) calc(var(--p) * 100%), var(--color-chalk))',
          ...
          <div className="relative mt-10 h-[13rem]">
            ...
            >
              <div className="relative max-w-[30rem] rounded-[10px] border border-rule bg-paper px-4 py-3.5 shadow-[0_18px_40px_-28px_rgba(13,15,14,0.35)]">
                <span className="absolute inset-y-2.5 left-0 w-[2px] rounded-full bg-recover" />
                ...
                <div className="mt-1 flex items-center gap-2">
                  <span className="h-[5px] w-[5px] rounded-full bg-recover" />
                  <span className="text-[0.8125rem] text-graphite-2">
